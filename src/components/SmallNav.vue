<template>
  <div
    class="inline-flex flex-wrap mb-4 gap-x-12"
    :class="{
  ...
  >
    <a
      href="tel:0864072814"
      class="flex items-center text-lg tracking-wide gap-x-2"
      ><svg
        width="18"
        height="18"
    ...
    <a
      ...
      class="flex items-center text-lg tracking-wide gap-x-2 y"
      ><svg
        xmlns="http://www.w3.org/2000/svg"
        width="18"
        height="18"
    ...
    <a
      v-if="showAddress"
      href="tel:0864072814"
      class="flex text-lg tracking-wide gap-x-2"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="18"
      ...
      <span>Ballysop, Whitechurch, <br />New Ross, Wexford</span></a
    >
  </div>
</template>
