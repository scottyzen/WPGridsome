<template>
  <button class="inline-block mr-6 md:mr-10" @click="toggleTheme" aria-label="Dark Mode Toggle">
    ...
    <svg v-show="darkmode" width="24" height="24" xmlns='http://www.w3.org/2000/svg' class='ionicon' viewBox='0 0 512 512'>
      <title>Sunny</title>
    ...
    <svg v-show="!darkmode" width="24" height="24" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
      <title>Moon</title>
