<template>
  ...
  >
    ...
    <div class="flex flex-col p-4">
      <h2
        class="mb-2 overflow-scroll leading-tight text-gray-800 whitespace-no-wrap hide-scrollbar"
      >
        {{ node.title }}
      </h2>
      <p
        class="flex-1 mb-3 text-sm leading-tight text-gray-600"
        v-html="node.excerpt.slice(0, 130) + '...'"
      ></p>
      <div
